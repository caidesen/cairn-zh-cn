...
森林点状探索是一种探索大片森林区域的简单方法，通常由连接各个分散兴趣点的分支小径组成。森林点状探索与传统地下城探索有一些相同之处，但它用浓密森林区域的非线性布局，替代了石墙和天花板。兴趣点不再以房间定义，而是以林间空地或森林景观的重大变化定义。不过，与探索地下城不同，角色可以走捷径、离开“小径”，或者爬上树看得更远（当然，这需要付出代价）。

### 探索森林

- 按照玩家指南中的*地下城*探索流程进行探索，但不要掷地下城事件，而应使用荒野事件表。
