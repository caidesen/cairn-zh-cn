...
| Vald | 瓦尔德 | 游戏世界/王国 |
| Fae | 妖精 | 森林中的古老族群 |
| Round | 轮 | 战斗中的完整循环，双方依次获得行动机会 |
| Turn | 回合 | 角色或一方的一次行动机会；探索流程中的时间单位 |
| Watch | 时段 | 荒野旅行时间单位 |
| Action | 行动 | 角色在回合或时段中的行为 |
...
| Scrivener | 文士 | 角色过往；不译为学者（scholar 另用）或文书 |
...
- 2026-09-20：将角色过往 Scrivener 的译名由「文书」改为「文士」，避免与 scholar「学者」及现代汉语「文书」（文件）混淆。
