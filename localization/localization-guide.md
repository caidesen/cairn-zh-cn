...
Although the Cairn rules exist in many forms (PDF, Google Docs, Word, etc), the SRD is probably the best choice for ease of translation. The entire SRD for both first and second editions of Cairn can be found in the Github [repository](https://github.com/yochaigal/cairn/).

## Translating the SRD

1. Copy the [SRD](https://github.com/yochaigal/cairn/) to a markdown editor such as [Obsidian](https://obsidian.md) or a web-based renderer like [dillinger.io](https://dillinger.io). If you know how to use Git, you can use [Visual Studio Code](https://code.visualstudio.com/). If you don't know markdown, don't worry! It's easy. Read more [here](https://guides.github.com/features/mastering-markdown/).
